    ...
    public void OpenBuyMenu()
    {
        ...
        for(int i = 0; i < buyItemButtons.Length; i++){
            ...
            if(itemsForSale[i] != "")
            {
                ...
                buyItemButtons[i].buttonImage.sprite = GameManager.instance.GetItemDetail(itemsForSale[i]).itemSprite;
    ...
    private void ShowSellItems()
    {
        ...
        for(int i = 0; i < sellItemButtons.Length; i++){
            ...
            if(GameManager.instance.itemsHeld[i] != "")
            {
                ...
                sellItemButtons[i].buttonImage.sprite = GameManager.instance.GetItemDetail(GameManager.instance.itemsHeld[i]).itemSprite;
